...
public class BatchTest {
	...
	public void runAll() {
		LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
				.selectors(selectClass(StackTests.class))
				.selectors(selectClass(QueueTests.class))
				.selectors(selectClass(PostfixEvaluatorTests.class))
				.selectors(selectClass(JsonValidatorTests.class))
				.build();
